...
void Game::start(){
    ...
    wallManager->placeWallsInLine(0,0,10);
    wallManager->placeWallsInLine(0,scene->height()-100,10);
    wallManager->placeWallsInColumns(0,100,7);
    wallManager->placeWallsInColumns(scene->width()-100,100,7);
